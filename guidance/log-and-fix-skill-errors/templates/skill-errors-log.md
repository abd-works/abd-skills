...
**Purpose:** When output is wrong, **do not edit the source** until the **correct output** is confirmed. Record each problem here first; complete the **fix the output** loop before the optional **improve the source** step. Full narrative: `guidance/log-and-fix-skill-errors/ide-files/correct-output.instructions.md`.
...
When the regenerated output is right: set **Status** to **confirmed**, fill **Example (correct)**, then you may optionally improve the source (see `guidance/log-and-fix-skill-errors/ide-files/correct-output.instructions.md` **Improve the source**).
