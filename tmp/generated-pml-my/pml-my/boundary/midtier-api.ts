...
export abstract class Midtier API {
  ...
  // TODO: rename — original: POST /customer; called from ensureCustomerExists when Cognito lacks customerId
  /** @invariant */
  abstract postCustomerCalledFromEnsurecustomerexistsWhenCognitoLacksCustomerid(): void
