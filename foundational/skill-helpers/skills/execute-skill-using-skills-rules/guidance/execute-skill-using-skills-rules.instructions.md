...
**Authoritative steps** live in **`../skills/execute-skill-using-skills-rules/SKILL.md`** (or **`../skills/execute-skill-using-skills-rules/SKILL.md`**).
...
4. If a rule or scanner fails, follow **`../skills/correct_output/SKILL.md`** to log and re-generate.
