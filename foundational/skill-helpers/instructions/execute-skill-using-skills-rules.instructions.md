...
**Authoritative steps** live in **`../skills/common/skill-rule-workflow.md`** (or **`../skills/common/skill-rule-workflow.md`**).
...
2. **After generating** — second pass: re-check the output against those rules (AI pass) **and** run the scanners (`python ../skills/common/scripts/run_scanners.py --skill-root <skill> --workspace <abs-path-to-output>`). Fix anything that fails before declaring done.
