...
- **Purpose** is outcome language — not pipeline mechanics, not prior-skill output references.
- **Core concepts** teach ideas and relationships before notation or file layout.
- **Rules** under `rules/*.md` are checkable specs for named artifacts with DO/DO NOT and per-bullet examples.
- **Templates** include at least one filled example for the audience.
- Anti-patterns belong in `rules/*.md`, not in the teaching voice.
- After editing `rules/*.md`, re-bundle into `SKILL.md`.

## When this rule does NOT apply

- Skills that are **not** practice skills (infrastructure, deployment, ops tooling).
