"""Scanner: No Xxe Unsafe Xml Parser (javascript)."""
...
RULE_SLUG = "no-xxe-unsafe-xml-parser"


class NoXxeUnsafeXmlParserScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoXxeUnsafeXmlParserScanner, RULE_SLUG)
