"""Scanner: No Toctou Outside Lock (javascript)."""
...
RULE_SLUG = "no-toctou-outside-lock"


class NoToctouOutsideLockScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoToctouOutsideLockScanner, RULE_SLUG)
