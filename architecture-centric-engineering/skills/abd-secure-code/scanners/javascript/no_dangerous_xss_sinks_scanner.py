"""Scanner: No Dangerous Xss Sinks (javascript)."""
...
RULE_SLUG = "no-dangerous-xss-sinks"


class NoDangerousXssSinksScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoDangerousXssSinksScanner, RULE_SLUG)
