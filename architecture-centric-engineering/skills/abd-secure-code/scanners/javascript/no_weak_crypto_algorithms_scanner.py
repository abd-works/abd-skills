"""Scanner: No Weak Crypto Algorithms (javascript)."""
...
RULE_SLUG = "no-weak-crypto-algorithms"


class NoWeakCryptoAlgorithmsScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoWeakCryptoAlgorithmsScanner, RULE_SLUG)
