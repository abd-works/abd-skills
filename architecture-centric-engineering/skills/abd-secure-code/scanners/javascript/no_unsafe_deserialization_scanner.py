"""Scanner: No Unsafe Deserialization (javascript)."""
...
RULE_SLUG = "no-unsafe-deserialization"


class NoUnsafeDeserializationScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoUnsafeDeserializationScanner, RULE_SLUG)
