"""Scanner: No Path Traversal In Paths (javascript)."""
...
RULE_SLUG = "no-path-traversal-in-paths"


class NoPathTraversalInPathsScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoPathTraversalInPathsScanner, RULE_SLUG)
