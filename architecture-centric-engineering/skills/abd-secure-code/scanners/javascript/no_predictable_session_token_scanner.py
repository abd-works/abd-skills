"""Scanner: No Predictable Session Token (javascript)."""
...
RULE_SLUG = "no-predictable-session-token"


class NoPredictableSessionTokenScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoPredictableSessionTokenScanner, RULE_SLUG)
