"""Scanner: No Plaintext Sensitive Data At Rest (javascript)."""
...
RULE_SLUG = "no-plaintext-sensitive-data-at-rest"


class NoPlaintextSensitiveDataAtRestScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoPlaintextSensitiveDataAtRestScanner, RULE_SLUG)
