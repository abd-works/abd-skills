"""Scanner: No Unsafe File Upload Handling (javascript)."""
...
RULE_SLUG = "no-unsafe-file-upload-handling"


class NoUnsafeFileUploadHandlingScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoUnsafeFileUploadHandlingScanner, RULE_SLUG)
