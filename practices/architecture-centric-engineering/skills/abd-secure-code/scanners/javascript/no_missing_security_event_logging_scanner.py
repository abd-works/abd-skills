"""Scanner: No Missing Security Event Logging (javascript)."""
...
RULE_SLUG = "no-missing-security-event-logging"


class NoMissingSecurityEventLoggingScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoMissingSecurityEventLoggingScanner, RULE_SLUG)
