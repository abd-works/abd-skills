"""Scanner: No Insufficient Login Rate Limiting (javascript)."""
...
RULE_SLUG = "no-insufficient-login-rate-limiting"


class NoInsufficientLoginRateLimitingScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoInsufficientLoginRateLimitingScanner, RULE_SLUG)
