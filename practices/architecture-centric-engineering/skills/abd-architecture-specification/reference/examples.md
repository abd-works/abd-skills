...
## Architecture Flow
Reuse the flow diagram and tech table from the architecture's source of truth.

## Instantiating the Domain
Domain-to-code mapping — module layout, shared core, naming contract. Common section shape; content differs by stack.
