...
**Source:** Practice-skill authoring convention (abd-architecture-specification); numbered walkthroughs let a reviewer pair each step against the sequence-diagram message.
