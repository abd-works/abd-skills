...
**Source:** Practice-skill authoring convention (abd-architecture-specification); the Mermaid diagrams are how the downstream implementation skill renders timing and structure from this document.
