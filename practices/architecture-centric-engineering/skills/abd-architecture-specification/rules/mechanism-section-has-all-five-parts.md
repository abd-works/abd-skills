...
**Source:** Practice-skill authoring convention (abd-architecture-specification). The five-part shape is the contract between this skill and `abd-build-architecture-skill`.
