# Grill me — abd-architecture-outline
...
Ask until the system boundary, neighbors, and mechanism choices are concrete:

- When someone says "the system," do all stakeholders picture the same boundary?
