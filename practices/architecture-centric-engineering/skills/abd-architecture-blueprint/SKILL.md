...
Produces four diagrams under `docs/architecture/`: `platform-architecture.drawio`, `module-overview.drawio`, `architecture-flow.drawio`, and `testing-flow.drawio`. All four must exist and verify PASS before the cell is marked done.
