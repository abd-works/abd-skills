"""Base scanner for secure JavaScript/TypeScript production code checks."""
...
class JsCodeScanner:
    """Base class for JavaScript secure-code scanners."""
    ...
    def _get_js_files(self, context: dict) -> list:
        return [
...
def _is_test_file(path: Path) -> bool:
    ...
    return ".test." in name or ".spec." in name or "/tests/" in str(path).replace("\\", "/")
