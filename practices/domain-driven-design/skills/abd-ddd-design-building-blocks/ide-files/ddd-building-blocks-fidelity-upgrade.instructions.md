...
When the domain model for a module advances in fidelity (e.g. Domain Language → domain model, domain model → Class Model) **and** a `*-ddd-building-blocks.md` file already exists for that module at the prior fidelity:
