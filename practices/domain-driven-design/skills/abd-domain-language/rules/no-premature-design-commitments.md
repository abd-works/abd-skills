...
The domain-language file contains no UML stereotypes, operation signatures, typed properties, cardinality notation, or structural classification labels. Design decisions belong to later skills. Passing means every concept block is plain prose. Failing means the file uses any of the forbidden notations.
...
**Source:** Inherited from abd-domain-language — no premature design commitments.
