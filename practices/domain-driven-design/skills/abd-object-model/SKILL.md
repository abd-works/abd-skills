...
**File name:** `object-model.md`. Add a `<name>-` prefix only when disambiguation is needed. For multi-module engagements: `<deliverables-folder>/modules/<module-name>-object-model.md`.
...
| --- | --- |
| `templates/domain-model-scaffold.md` | The object model file with typed class blocks under each KA. |
...
python skills/execute-skill-using-skills-rules/scripts/run_scanners.py \
  --skill-root skills/abd-object-model \
...
- **Per-phase output file** — named `[<name>-]object-model.md`. No prior or later phase content lives in it.
...
- **All CRC collaborators accounted for** — in parameters, return types, properties, or `Interaction:` steps.
