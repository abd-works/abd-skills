# Skill Rule Workflow — Story-Driven Delivery

Shared workflow for all story-driven-delivery practice skills. Skills reference this file for read-gates, output file resolution, and per-rule verdict format.
