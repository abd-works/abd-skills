...
Apply these items in every SDD skill's `## Validate` pass, in addition to skill-specific bullets.
...
- **Diagram on disk** — the `.drawio` file named in `## Diagram workflow` exists before the cell is marked done.
...
- **Incomplete context** — gaps surfaced honestly; no fabricated structure to fill holes. See [`../../reference/handling-incomplete-context.md`](../../reference/handling-incomplete-context.md).
- **System mode** — new-system vs existing-system discipline applied. See [`../../reference/new-vs-existing-system.md`](../../reference/new-vs-existing-system.md).
