...
Read `common/reference/stages/shaping.md` and `practices/kanban/reference/artifact-layout.md`.
...
If the user provided text after the command, treat it as the project or scope focus.