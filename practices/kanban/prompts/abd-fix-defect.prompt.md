...
1. **Failing Test (RED)** � find or write the test that catches this defect: `.cursor/skills/abd-story-acceptance-test/SKILL.md`
...
5. **Acceptance Criteria** _(if exists)_ � correct any WHEN/THEN that was wrong or missing: `.cursor/skills/abd-story-acceptance-criteria/SKILL.md`
6. **Spec by Example** _(if exists)_ � update or add scenarios that cover the defect: `.cursor/skills/abd-story-specification/SKILL.md`
