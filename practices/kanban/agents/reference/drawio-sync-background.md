...
3. **Log every queue** to `docs/planning/delivery-war-room/metrics-log.jsonl`:
...
| --- | --- | --- |
| `abd-domain-terms` | `domain-terms.md` | optional `<name>-class-diagram.drawio` under same folder |
| `abd-ubiquitous-language` | `ubiquitous-language.md` | `<increment>-class-diagram.drawio` under `exploration/domain/` |
| `abd-class-responsibility-collaborator` | `crc.md` | `crc-class-diagram.drawio` under `specification/` |
| `abd-object-model` | `object-model.md` | `object-model-class-diagram.drawio` under `engineering/` |
