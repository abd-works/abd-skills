...
- **Coverage:** {{STAGES_CHECKED_IN_SESSION — e.g. "Exploration (AC), Specification, Engineering (ATDD + code), regression testing (per session coverage)"}}
...
- **Category:** L
- **Coverage:** Exploration (AC), Specification, Engineering (ATDD + implementation), regression testing (per session coverage)
