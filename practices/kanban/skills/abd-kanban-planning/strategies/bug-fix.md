...
| --- | --- | --- |
| Exploration | story | acceptance-criteria (isolate defect surface) |
| Engineering | story | ATDD, clean-code |
| Exploration (reverse) | story | acceptance-criteria (capture corrected intent), spec-by-example (optional) |
