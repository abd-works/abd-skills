...
| --- | --- | --- |
| Discovery | all | story-mapping (minimal — frame the experiment) |
| Exploration | story | acceptance-criteria (minimal — learning-goal AC only) |
| Engineering | story | ATDD (minimal), clean-code (spike quality acceptable) |
