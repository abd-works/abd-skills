...
| Shaping | all | abd-domain-glossary, abd-architecture-outline, abd-story-mapping, abd-thin-slicing |
...
| Domain scan | abd-domain-glossary | shaping | — |
