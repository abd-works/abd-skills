...
- When no strategy fits, include a section like `## Strategy: custom` with a proposed slug for later save under `reference/strategies/`.
...
Blended with: `reference/strategies/new-initiative-business-user-experience-risk.md` (for the second actor path).
```
