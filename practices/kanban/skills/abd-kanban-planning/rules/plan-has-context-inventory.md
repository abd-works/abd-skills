...
The saved plan at `<workspace>/docs/planning/abd-kanban-lead/agile-delivery-plan.md` must include a **context inventory** section that lists **Provided** context and **Missing** (or "not yet provided") context separately, and — when critical context is missing — the implications for run sequencing.
