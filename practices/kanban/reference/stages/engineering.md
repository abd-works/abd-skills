...
| 2b | **Domain-driven design** | `drawio-domain-sync` | Business Expert or Engineer | **Background** after object-model — `object-model-class-diagram.drawio` |
...
2. `increments/<n>-<slug>/engineering/object-model.md` + domain code (Engineer).
3. Acceptance tests then production code (Engineer).
