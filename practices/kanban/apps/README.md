...
Runnable applications that ship with the kanban practice package. Not deployed to engagement workspaces ” run from this folder against an engagement's `docs/kanban/` tree.

| App | Purpose |
| --- | --- |
| [abd-delivery-agent-kanban](abd-delivery-agent-kanban/) | Live read-only board UI ” polls `delivery-kanban-board/board.json` and related planning files |
