...
- Name: visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts >> Show Skill Execution and Completion Indicators >> Scenario 4: Pending skill shows no icon
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts:129:7

# Error details

```
SyntaxError: Unexpected token '﻿', "﻿{
  "sch"... is not valid JSON
```
