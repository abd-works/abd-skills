...
- Name: visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts >> Show Skill Execution and Completion Indicators >> Scenario 2: Executing skill shows bot icon on that row only
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts:48:7
