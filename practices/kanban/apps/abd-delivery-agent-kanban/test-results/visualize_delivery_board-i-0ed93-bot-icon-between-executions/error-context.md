...
- Name: visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts >> Show Skill Execution and Completion Indicators >> Scenario 5: Focus skill shows bot icon between executions
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts:183:7
