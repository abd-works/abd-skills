...
- Name: visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts >> Show Skill Execution and Completion Indicators >> Scenario 3: Skill under review shows review icon on that row only
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\show_skill_execution_and_completion_indicators_e2e.spec.ts:88:7
