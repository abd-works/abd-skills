...
- Name: visualize_delivery_board\inspect_skill_progress\expand_ticket_skill_list_e2e.spec.ts >> Expand Ticket Skill List >> Scenario 2: Stage queue ticket has no expand control
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\expand_ticket_skill_list_e2e.spec.ts:52:7
