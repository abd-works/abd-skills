...
- Name: manage_agent_lifecycle_via_cursor_sdk\orchestrate_delivery_cycle\manual_drag_in_stage_flow_logic_e2e.spec.ts >> Advance Ticket to Next Stage (Same Scope) >> Scenario 1: Ticket advances when stage complete and next stage has same scope
- Location: tests\e2e\manage_agent_lifecycle_via_cursor_sdk\orchestrate_delivery_cycle\manual_drag_in_stage_flow_logic_e2e.spec.ts:12:7
