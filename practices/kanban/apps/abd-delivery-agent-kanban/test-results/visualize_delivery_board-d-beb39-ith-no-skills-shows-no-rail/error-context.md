...
- Name: visualize_delivery_board\display_board_layout\show_assigned_skills_per_stage_e2e.spec.ts >> Show Assigned Skills per Stage >> Scenario 2: Stage with no skills shows no rail
- Location: tests\e2e\visualize_delivery_board\display_board_layout\show_assigned_skills_per_stage_e2e.spec.ts:37:7
