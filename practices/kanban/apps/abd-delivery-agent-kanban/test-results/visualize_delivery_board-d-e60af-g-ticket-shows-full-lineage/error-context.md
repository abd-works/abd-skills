...
- Name: visualize_delivery_board\display_board_layout\display_backlog_tickets_e2e.spec.ts >> Display Backlog Tickets >> Scenario 2: Hovering backlog ticket shows full lineage
- Location: tests\e2e\visualize_delivery_board\display_board_layout\display_backlog_tickets_e2e.spec.ts:66:7
...
Locator: locator('[data-ticket="STORY-003"]').first()
Expected pattern: /PetStore > Sprint 1 > Add Pet/
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveAttribute" with timeout 5000ms
  - waiting for locator('[data-ticket="STORY-003"]').first()
