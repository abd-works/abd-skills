...
- Name: visualize_delivery_board\display_ticket_cards\show_active_skill_and_agent_on_ticket_e2e.spec.ts >> Show Active Skill and Agent on Ticket >> Scenario 1: Executing agent shown on ticket
- Location: tests\e2e\visualize_delivery_board\display_ticket_cards\show_active_skill_and_agent_on_ticket_e2e.spec.ts:9:7
