...
- Name: visualize_delivery_board\display_board_layout\organize_tickets_into_stage_groups_by_delivery_phase_e2e.spec.ts >> Organize Tickets into Stage Groups by Delivery Phase >> Scenario 1: Tickets grouped under their assigned stages
- Location: tests\e2e\visualize_delivery_board\display_board_layout\organize_tickets_into_stage_groups_by_delivery_phase_e2e.spec.ts:18:7
...
Locator: locator('.kb-stage-group[data-stage="discovery"]').locator('.kb-sub-col--ip').locator('[data-ticket="101"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.kb-stage-group[data-stage="discovery"]').locator('.kb-sub-col--ip').locator('[data-ticket="101"]')
