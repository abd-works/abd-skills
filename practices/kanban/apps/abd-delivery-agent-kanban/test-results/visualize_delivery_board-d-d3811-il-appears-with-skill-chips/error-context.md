...
- Name: visualize_delivery_board\display_board_layout\show_assigned_skills_per_stage_e2e.spec.ts >> Show Assigned Skills per Stage >> Scenario 1: Stage skill rail appears with skill chips
- Location: tests\e2e\visualize_delivery_board\display_board_layout\show_assigned_skills_per_stage_e2e.spec.ts:16:7
