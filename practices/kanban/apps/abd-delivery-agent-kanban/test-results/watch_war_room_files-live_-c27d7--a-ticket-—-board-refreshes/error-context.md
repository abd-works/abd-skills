...
- Name: watch_war_room_files\live_refresh_when_board_files_change_e2e.spec.ts >> Board Reflects Agent Changes Automatically >> Scenario 1: Agent moves a ticket — board refreshes
- Location: tests\e2e\watch_war_room_files\live_refresh_when_board_files_change_e2e.spec.ts:16:7
