...
- Name: visualize_delivery_board\display_ticket_cards\show_active_skill_and_agent_on_ticket_e2e.spec.ts >> Show Active Skill and Agent on Ticket >> Scenario 3: Bot icon visible without agent avatar
- Location: tests\e2e\visualize_delivery_board\display_ticket_cards\show_active_skill_and_agent_on_ticket_e2e.spec.ts:94:7
