...
- Name: manage_agent_lifecycle_via_cursor_sdk\bootstrap_agent_from_role_definition\resolve_agent_definition_from_role_e2e.spec.ts >> Resolve Agent Definition from Role >> Scenario 2: Role "kanban-lead" resolves to its agent definition
- Location: tests\e2e\manage_agent_lifecycle_via_cursor_sdk\bootstrap_agent_from_role_definition\resolve_agent_definition_from_role_e2e.spec.ts:16:7
