...
- Name: visualize_delivery_board\inspect_skill_progress\expand_ticket_skill_list_e2e.spec.ts >> Expand Ticket Skill List >> Scenario: Agent-avatar drop records intent without moving ticket stage
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\expand_ticket_skill_list_e2e.spec.ts:120:7
