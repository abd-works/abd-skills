...
- Name: visualize_delivery_board\inspect_skill_progress\expand_ticket_skill_list_e2e.spec.ts >> Expand Ticket Skill List >> Scenario 1: Delivery Lead expands active ticket skill list
- Location: tests\e2e\visualize_delivery_board\inspect_skill_progress\expand_ticket_skill_list_e2e.spec.ts:20:7
