...
- Name: visualize_delivery_board\display_board_layout\display_backlog_tickets_e2e.spec.ts >> Display Backlog Tickets >> Scenario 1: Backlog tickets ordered by priority
- Location: tests\e2e\visualize_delivery_board\display_board_layout\display_backlog_tickets_e2e.spec.ts:16:7
...
Locator: locator('.kb-stage-group[data-stage="discovery"]').locator('.kb-sub-col--ip').locator('[data-ticket="STORY-003"]').getByText('Add Pet', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.kb-stage-group[data-stage="discovery"]').locator('.kb-sub-col--ip').locator('[data-ticket="STORY-003"]').getByText('Add Pet', { exact: true })
