# Story Map — PawPlace mini (discovery)
...
**Domain modules:** Store, Catalog, Cart, Order — see `../domain/domain-terms.md`.
...
(E) Shop & Pay Online
    ...
    (E) Fulfill Click-and-Collect Orders
