...
Do **not** assume a predetermined folder name like `stories/`, `docs/`, `specs/`, or similar unless the skill explicitly creates one.
...
- Read every file in **`rules/`** for the active skill. Treat each DO / DO NOT as a shape contract — not a suggestion.
