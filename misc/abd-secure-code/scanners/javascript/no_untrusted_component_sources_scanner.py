"""Scanner: No Untrusted Component Sources (javascript)."""
...
RULE_SLUG = "no-untrusted-component-sources"


class NoUntrustedComponentSourcesScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoUntrustedComponentSourcesScanner, RULE_SLUG)
