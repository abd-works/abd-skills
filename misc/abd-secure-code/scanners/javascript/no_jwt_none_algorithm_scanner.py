"""Scanner: No Jwt None Algorithm (javascript)."""
...
RULE_SLUG = "no-jwt-none-algorithm"


class NoJwtNoneAlgorithmScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoJwtNoneAlgorithmScanner, RULE_SLUG)
