"""Scanner: No Eval Dynamic Code Execution (javascript)."""
...
RULE_SLUG = "no-eval-dynamic-code-execution"


class NoEvalDynamicCodeExecutionScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoEvalDynamicCodeExecutionScanner, RULE_SLUG)
