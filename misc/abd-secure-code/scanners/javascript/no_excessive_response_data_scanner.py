"""Scanner: No Excessive Response Data (javascript)."""
...
RULE_SLUG = "no-excessive-response-data"


class NoExcessiveResponseDataScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoExcessiveResponseDataScanner, RULE_SLUG)
