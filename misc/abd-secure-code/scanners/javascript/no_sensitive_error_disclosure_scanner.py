"""Scanner: No Sensitive Error Disclosure (javascript)."""
...
RULE_SLUG = "no-sensitive-error-disclosure"


class NoSensitiveErrorDisclosureScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoSensitiveErrorDisclosureScanner, RULE_SLUG)
