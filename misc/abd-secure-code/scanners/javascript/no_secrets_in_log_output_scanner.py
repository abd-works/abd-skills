"""Scanner: No Secrets In Log Output (javascript)."""
...
RULE_SLUG = "no-secrets-in-log-output"


class NoSecretsInLogOutputScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoSecretsInLogOutputScanner, RULE_SLUG)
