"""Scanner: No Hardcoded Secrets (javascript)."""
...
RULE_SLUG = "no-hardcoded-secrets"


class NoHardcodedSecretsScanner(JsCodeScanner):
...
if __name__ == "__main__":
    run_scanner_main(NoHardcodedSecretsScanner, RULE_SLUG)
