...
Points),  this  booklet  is  filled  with  hundreds  of  sample
powers that should be easy to use as-is or modify slightly

to make them work for your hero. Take advantage of that
