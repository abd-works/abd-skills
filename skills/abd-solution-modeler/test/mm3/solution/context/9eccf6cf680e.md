...
Trained Only: If “Trained Only” is included on the line be-
low the skill’s name, you must have at least 1 rank in the
skill in order to use it. If “Trained Only” is absent, untrained
