...
1d20 once and record the result. Otherwise, do not roll for
Combat Powers.

Chi Mastery: Array (12 points plus 3 Alternate
...
Death Touch: Progressive Weaken
Stamina 4 (Resisted by Fortitude)

Flurry of Blows: Selective Multiattack 5,
Variable Descriptor 2 (any attack effect
you wield, up to the attack’s rank)

Iron Fist: Strength-based Damage 5,

Penetrating 8, Inaccurate

Mental Weapon: Damage 6, Alternate

Resistance (Will)

Nerve Strike: Cumulative Affliction 6
...
Missile Redirection: Immunity 5 (Thrown

Weapons), Concentration Duration, Reflect,
Redirect • 15 points
