...
tion box or send you flying off the edge. You’re taking a risk.)

More than one degree of failure on the Deception check
means you put yourself in a bad position; you are vulner-
able against the target’s attacks until the start of your next
round!
...
trade, perform the profession’s daily tasks, supervise un-
...
check for you in secret, so you won’t know whether or not
your character’s skill is entirely up to the task.
