...
Mentalist: Take Telepathy, listed immediately
below, then roll on the Mentalist Table as directed.

Telepathy: Mind Reading 5 Linked to Area Mental

Communication 3 • 25 points

Mentalist Table: Roll 1d20 once and record the
result as the first power of an array, then roll 1d20
