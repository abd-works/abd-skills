...
Chunks: 267  |  AI calls: 0  |  Time: 0.652s
Concept mentions: 1323  |  Relationships: 386
...
### Character
Total evidence instances: 205 across 2 concepts

  **Character**  [definition:5 | table:4 | rule:86 | example:40 | mention:35]
  **Complication**  [definition:3 | table:1 | rule:17 | example:6 | mention:8]

### Character Traits
Total evidence instances: 376 across 4 concepts

  **Skill**  [definition:1 | rule:58 | example:21 | mention:38]
  **Defense**  [definition:9 | table:7 | rule:35 | example:8 | mention:45]
  **Advantage**  [definition:5 | rule:29 | example:11 | mention:36]
  **Ability**  [definition:2 | rule:30 | example:14 | mention:27]

### Combat
Total evidence instances: 272 across 2 concepts

  **Action**  [definition:37 | rule:96 | example:23 | mention:53]
  **Condition**  [definition:3 | table:1 | rule:19 | example:6 | mention:34]

### Powers
Total evidence instances: 548 across 3 concepts

  **Effect**  [definition:29 | table:1 | rule:110 | example:51 | mention:36]
  **Power**  [definition:6 | table:1 | rule:101 | example:41 | mention:77]
  **Modifier**  [definition:4 | rule:51 | example:16 | mention:24]

### Resolution
Total evidence instances: 254 across 2 concepts

  **Check**  [definition:13 | table:3 | rule:107 | example:40 | mention:15]
  **Degree**  [definition:1 | table:2 | rule:35 | example:7 | mention:31]
