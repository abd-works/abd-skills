...
Chunks: 267  |  AI calls: 9  |  Time: 293.407s
Concept mentions: 1420  |  Relationships: 322
...
### Character
Total evidence instances: 222 across 8 concepts

  **Character**  [definition:11 | table:4 | rule:86 | example:38 | mention:35]
  **Complication**  [definition:3 | table:1 | rule:17 | example:6 | mention:11]
  **PowerPoint**  [table:3]
  **PowerLevel**  [mention:2]
  **Motivation**  [mention:2]
  **Power Level**  [definition:1]
  **Power Point**  [mention:1]
  **Archetype**  [mention:1]

### Character Traits
Total evidence instances: 424 across 7 concepts

  **Skill**  [definition:1 | table:9 | rule:58 | example:20 | mention:40]
  **Defense**  [definition:9 | table:7 | rule:35 | example:10 | mention:46]
  **Ability**  [definition:2 | table:10 | rule:30 | example:16 | mention:32]
  **Advantage**  [definition:5 | table:5 | rule:29 | example:13 | mention:35]
  **Equipment**  [mention:2]
  **Character Trait**  [example:1]
  **Trait**  [mention:1]

### CharacterTraits
Total evidence instances: 6 across 2 concepts

  **Ability**  []
  **Skill**  []

### Combat
Total evidence instances: 278 across 3 concepts

  **Action**  [definition:37 | rule:96 | example:21 | mention:53]
  **Condition**  [definition:3 | table:1 | rule:19 | example:7 | mention:40]
  **Construct**  [definition:1]

### Gadgets & Gear
Total evidence instances: 5 across 5 concepts

  **Weapon**  [table:1]
  **Vehicle**  [table:1]
  **Headquarters**  [definition:1]
  **Size**  [definition:1]
  **Toughness**  [definition:1]

### Powers
Total evidence instances: 556 across 4 concepts

  **Power**  [definition:6 | table:4 | rule:101 | example:36 | mention:80]
  **Effect**  [definition:29 | table:1 | rule:110 | example:50 | mention:37]
  **Modifier**  [definition:4 | table:2 | rule:51 | example:15 | mention:24]
  **PowerLevel**  [mention:3]

### Resolution
Total evidence instances: 253 across 2 concepts

  **Check**  [definition:13 | table:3 | rule:107 | example:40 | mention:15]
  **Degree**  [definition:1 | table:2 | rule:35 | example:5 | mention:32]
