...
- **`fixture/toy-polite-dialogue/`** — minimal valid skill (polite multi-phase dialogue) used as the **canonical example** for standards and for **`agentic-skill-builder`** operator/graph tests (path resolved from repo root).
