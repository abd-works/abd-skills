...
imports from `common/diagram_story_sync`:
...
1. Put **`common/`**, this skill's **`scripts/`**, and **story-graph-ops**
...
- **common/diagram_story_sync** — shared platform-agnostic primitives.
