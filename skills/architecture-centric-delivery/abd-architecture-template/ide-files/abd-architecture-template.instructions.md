...
Read `skills/engineering/abd-architecture-template/SKILL.md` and follow its **Build** steps. The reference document is the input contract for `abd-build-architecture-skill`.
