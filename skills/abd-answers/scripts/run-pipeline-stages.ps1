...
.EXAMPLE
  .\scripts\rag\run-pipeline-stages.ps1 -SourcePath "C:\data\my-docs"

.EXAMPLE
  .\scripts\rag\run-pipeline-stages.ps1 -SourcePath "C:\data\my-docs" -SkipConvert
#>
param(
...
$py = "python"
$convert = Join-Path $repo "scripts\source-convert\convert_to_markdown.py"
$chunk = Join-Path $repo "scripts\source-convert\chunk_markdown.py"
