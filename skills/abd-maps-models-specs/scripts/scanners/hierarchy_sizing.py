...
Rule file: rules/hierarchy-approximately-4-to-9-children.md
...
Usage (standalone):
    python scripts/scanners/hierarchy_sizing.py [--input <path>]
...
def main() -> int:
    ...
    print(f"  Rule: rules/hierarchy-approximately-4-to-9-children.md\n")
    for v in violations:
