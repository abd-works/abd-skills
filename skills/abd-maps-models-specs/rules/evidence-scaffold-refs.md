...
phases: [step4]
order: 10
scanner: scanners/evidence_scaffold_refs.py
impact: HIGH
---
...
The scanner (`scanners/evidence_scaffold_refs.py`) flags concept IDs in evidence files that do not exist in the scaffold.
