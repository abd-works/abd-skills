...
**Artifact:** `phase3/mm3_story_map.json` (paths per [`shaped-story-map.md`](../../library/shaped-story-map.md)).
...
See also: `[pipeline_invariants.md](pipeline_invariants.md)` (layers A–D), and `[shaped-story-map.md](../../parts/phases/shaped-story-map.md)` for the Phase 3 JSON shape and validators.
...
**Focus (this phase):** Phase 3 **mm3_story_map.json** — shaped story map, **evidence_chunk_ids[]**, scanner **phase3_story_map_evidence.py**. Read **shaped-story-map.md** + rule **shaped-story-shape**.
