...
# Built phase bundle — validate-render
...
**Authoritative context:** Phase 8 row in [`content/parts/process.md`](../../parts/process.md); this file expands that row.
...
**Focus (this phase):** Phase 8 gates — **`build.py`** pipeline, **`chunks_must_be_referenced.py`**, manifest, reproducible reports. Render traces to validated artifacts.
