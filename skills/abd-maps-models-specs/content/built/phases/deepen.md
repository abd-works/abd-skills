...
Deepening is **reasoning-heavy**. You may use **chat**, **agent sessions**, or **small drivers** that the skill **documents** (see phase file and [`execution-and-success.md`](../../parts/library/execution-and-success.md)).
...
**Authoritative context:** Phase 6 row in [`content/parts/process.md`](../../parts/process.md); this file expands that row.
