...
**Optional:** **`known_skill_workspaces`** — other roots this skill may switch to (see **`abd-skill-builder`** [`docs/workspace-config.md`](../abd-skill-builder/docs/workspace-config.md)).
...
Workspace-local parameters (unique to that project) may live under **`conf/`** at the skill workspace root alongside **`solution.conf`** (or as documented per skill). See **`abd-skill-builder`** [`docs/workspace-config.md`](../abd-skill-builder/docs/workspace-config.md) for the two-level model.
