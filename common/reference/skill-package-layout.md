...
| Piece | Role |
| --- | --- |
| **`SKILL.md`** | Thin router: purpose, when-to-use, mandatory `common/reference/skill-workflow.md` read-gates. No template tables, no `## Validate` when scanners exist. Orchestration in `reference/generate.md`. |
