...
| Piece | Role |
| --- | --- |
| **`SKILL.md`** | Thin router: purpose, when-to-use, mandatory bootstrap (read `common/skill-workflow.md` + every linked file in full), validate gate. No inlined rule prose. |
