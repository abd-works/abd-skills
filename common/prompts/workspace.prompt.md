...
The canonical engagement folder is **`workspace.active_skill_workspace`** in **`skill-config.json`** at the **abd-skills repository root** (not inside a packaged skill).
