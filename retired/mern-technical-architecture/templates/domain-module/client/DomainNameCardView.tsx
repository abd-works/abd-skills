/**
 * DomainNameCardView.tsx — Presentational component for a single domain entity.
 *
...
interface DomainNameCardViewProps {
  item: DomainName;
  onSelect?: (item: DomainName) => void;
}

export function DomainNameCardView({ item, onSelect }: DomainNameCardViewProps) {
  return (
    <div
