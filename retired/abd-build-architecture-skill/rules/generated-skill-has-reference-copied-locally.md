...
- Document the source so a maintainer can resync if the reference is updated upstream.
  ...
  **Example (pass):** A note at the top of `inputs/architecture-reference.md` reads: `Source: architecture-centric-engineering/skills/abd-architecture-specification output for {{ArchName}} produced on YYYY-MM-DD.`
