...
- **DO:** List the constants with their values directly in the domain model block.
...
- **DO NOT:** Use the domain model responsibility label as a property name when the label describes a structural rule, not a state the class holds.
