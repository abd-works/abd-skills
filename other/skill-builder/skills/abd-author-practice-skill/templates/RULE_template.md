<!--
  ...
  Bundle rule prose into the skill’s SKILL.md (between common markers) with:
    python skills/common/scripts/bundle_rules_into_skill_md.py --skill-root skills/<your-skill>
